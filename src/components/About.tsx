        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center animate-fade-in">
            <div className="relative">
              ...
              <img 
                src={profileImg} 
                alt="Ishara Madushan" 
                className="relative rounded-2xl w-80 h-80 object-cover border-2 border-primary/20 shadow-2xl"
              />
            </div>
          </div>
          ...
          <div className="space-y-6 animate-fade-in-up">
            ...
            <div className="grid gap-4 pt-4">
              <div className="flex gap-4 items-start p-4 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300">
              ...
              <div className="flex gap-4 items-start p-4 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300">
                ...
                <div>
                  <h3 className="font-semibold mb-1">AI/ML Engineering</h3>
                  <p className="text-sm text-muted-foreground">
